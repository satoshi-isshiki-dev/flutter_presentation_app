...
class ApiClient {
  ...
  Future<List<T>> _post<T extends BaseModel>(
    ...
    try {
      ...
      // ! А сейчас вот 🤷‍♂️ 🤷‍♂️ 🤷‍♂️ ... (так как в ТЗ написано, что сохрнаять в LocalStorage с генерированным ID)
      // Т.е. POST запрос делается, просто так, чтобы был (он ничего невозвращает всегда одни и теже данные)
